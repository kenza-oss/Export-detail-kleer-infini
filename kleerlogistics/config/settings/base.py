"""
Base settings for KleerLogistics project.
"""
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-^f14iq795^q7^_1b$q0f%xvo3ky)@i4)5j4!pyk$&bf8e9!w1q')
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'kleerlogistics.log',
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
...
# Celery Configuration (désactivé temporairement)
